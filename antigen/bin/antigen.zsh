...
if [[ $ANTIGEN_CACHE != false ]]; then
  ANTIGEN_CACHE="${ANTIGEN_CACHE:-${ADOTDIR:-$HOME/.local/share/zsh/.antigen}/init.zsh}"
  ANTIGEN_RSRC="${ANTIGEN_RSRC:-${ADOTDIR:-$HOME/.local/share/zsh/.antigen}/.resources}"
...
-antigen-env-setup () {
  ...
  -antigen-set-default ADOTDIR $HOME/.local/share/zsh/.antigen
...
ANTIGEN_DEBUG_LOG=${ANTIGEN_DEBUG_LOG:-${ADOTDIR:-$HOME/.local/share/zsh/.antigen}/debug.log}
LOG () {
